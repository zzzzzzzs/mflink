...
export interface RenderResult<ComponentType, WrapperType = ComponentType> extends RenderResultQueries {
     ...
     */
    debug: (element?: Element | HTMLDocument | (Element | HTMLDocument)[], maxLength?: number, options?: PrettyDOMOptions) => void;
    /**
     * @description
 ...
 */
export interface RenderDirectiveOptions<WrapperType, Properties extends object = {}, Q extends Queries = typeof queries> extends RenderComponentOptions<Properties, Q> {
    /**
     * @description
